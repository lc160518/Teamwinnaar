...
vehicle = rocketConfig.vehicleProperties(1.3, 0.1, 0.5, np.deg2rad(15), np.deg2rad(150))
...
if __name__ == "__main__":
    while (sim_time < time_lim):
        ...
        graphics.moveAgent(rocket, rocket_phys.state_vector["pz"],
                           rocket_phys.state_vector["px"])  # Update Graphics and Plots
