...
float PAngleRoll = 2; float PAnglePitch = PAngleRoll; // waardes van de P van de hoek
float IAngleRoll = 0; float IAnglePitch = IAngleRoll; // waardes van de I van de hoek
float DAngleRoll = 0; float DAnglePitch = DAngleRoll; // waardes van de D van de hoek
